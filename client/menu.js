...
export function initMenu(uiLayer, nascondiElementiHTML, distruggiUI, setHtmlContainer, mostraAuth, logoutFn) {
...
async function mostraSchermataStats(parentContainer) {
    ...
    try {
        ...
        data.classifica.forEach((p, i) => {
            ...
            const col   = i === 0 ? "rgb(255,215,0)" : "rgba(255,255,255,0.85)";
            const bg    = i % 2 === 0 ? "rgba(255,255,255,0.03)" : "transparent";
            html += `<div style="display:grid;grid-template-columns:${cols};padding:${pad};
                background:${bg};color:${col};border-bottom:1px solid rgba(255,255,255,0.05)">
